...
import com.abdipor.appthemehelper.util.*
import com.abdipor.appthemehelper.util.ATHUtil.resolveColor
import com.abdipor.music1.App
import com.abdipor.music1.R
import com.abdipor.music1.activities.base.AbsMusicServiceActivity
import com.abdipor.music1.activities.tageditor.WriteTagsAsyncTask
...
import com.abdipor.music1.lyrics.LrcHelper
import com.abdipor.music1.lyrics.LrcView
import com.abdipor.music1.model.Song
import com.abdipor.music1.model.lyrics.Lyrics
import com.abdipor.music1.util.LyricUtil
...
class LyricsActivity : AbsMusicServiceActivity(), View.OnClickListener,
        ...
        val materialDialog = MaterialDialog(this)
            .show {
                ...
                negativeButton(R.string.action_search) {
                    NotrikaUtil.openUrl(this@LyricsActivity, googleSearchLrcUrl)
                }
                input(
    ...
    private fun showLyricsSaveDialog() {
        ...
        val materialDialog = MaterialDialog(
            ...
            negativeButton(R.string.action_search) {
                NotrikaUtil.openUrl(this@LyricsActivity, getGoogleSearchUrl())
            }
            input(
                hint = getString(R.string.paste_lyrics_here),
                prefill = content,
