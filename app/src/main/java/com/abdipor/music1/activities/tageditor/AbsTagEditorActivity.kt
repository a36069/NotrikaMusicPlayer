...
import com.abdipor.music1.R.drawable
...
abstract class AbsTagEditorActivity : AbsBaseActivity() {
    ...
    private fun setUpImageView() {
        loadCurrentImage()
        items = listOf(
            getString(com.abdipor.music1.R.string.pick_from_local_storage),
            getString(com.abdipor.music1.R.string.web_search),
            getString(com.abdipor.music1.R.string.remove_cover)
        )
    ...
    protected fun writeValuesToFiles(
        ...
        NotrikaUtil.hideSoftKeyboard(this)
