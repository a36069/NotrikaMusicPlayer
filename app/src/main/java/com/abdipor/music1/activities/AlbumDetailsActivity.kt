...
import com.abdipor.music1.activities.tageditor.AlbumTagEditorActivity
...
import com.abdipor.music1.mvp.presenter.AlbumDetailsPresenter
import com.abdipor.music1.mvp.presenter.AlbumDetailsView
...
class AlbumDetailsActivity : AbsSlidingMusicPanelActivity(), AlbumDetailsView, CabHolder {
    ...
    override fun aboutAlbum(lastFmAlbum: LastFmAlbum) {
        if (lastFmAlbum.album != null) {
            ...
            if (lastFmAlbum.album.listeners.isNotEmpty()) {
                ...
                listeners.text = NotrikaUtil.formatValue(lastFmAlbum.album.listeners.toFloat())
                scrobbles.text = NotrikaUtil.formatValue(lastFmAlbum.album.playcount.toFloat())
            }
        }
    }
    ...
    override fun loadArtistImage(artist: Artist) {
        ArtistGlideRequest.Builder.from(Glide.with(this), artist)
            ...
            .dontAnimate()
            .dontTransform()
            .into(object : NotrikaMusicColoredTarget(artistImage) {
