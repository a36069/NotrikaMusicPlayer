...
import com.abdipor.appthemehelper.ATH
import com.abdipor.appthemehelper.ThemeStore
import com.abdipor.appthemehelper.common.ATHToolbarActivity
...
import com.abdipor.music1.LanguageContextWrapper
import com.abdipor.music1.R
import com.abdipor.music1.util.PreferenceUtil
import com.abdipor.music1.util.NotrikaUtil
import com.abdipor.music1.util.theme.ThemeManager
import java.util.*
...
abstract class AbsThemeActivity : ATHToolbarActivity(), Runnable {
    ...
    fun setDrawUnderStatusBar() {
        NotrikaUtil.setAllowDrawUnderStatusBar(window)
    }

    fun setDrawUnderNavigationBar() {
        NotrikaUtil.setAllowDrawUnderNavigationBar(window)
    }
