...
import com.abdipor.music1.adapter.SearchAdapter
import com.abdipor.music1.mvp.presenter.SearchPresenter
import com.abdipor.music1.mvp.presenter.SearchView
...
class SearchActivity : AbsMusicServiceActivity(), OnQueryTextListener, TextWatcher, SearchView {
    ...
    private fun hideSoftKeyboard() {
        NotrikaUtil.hideSoftKeyboard(this@SearchActivity)
        if (searchView != null) {
