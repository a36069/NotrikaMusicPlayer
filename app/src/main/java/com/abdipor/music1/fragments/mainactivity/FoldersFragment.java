...
package com.abdipor.music1.fragments.mainactivity;
...
import com.abdipor.music1.adapter.SongFileAdapter;
import com.abdipor.music1.fragments.base.AbsMainActivityFragment;
...
import com.abdipor.music1.interfaces.LoaderIds;
import com.abdipor.music1.interfaces.MainActivityFragmentCallbacks;
import com.abdipor.music1.misc.DialogAsyncTask;
import com.abdipor.music1.misc.UpdateToastMediaScannerCompletionListener;
import com.abdipor.music1.misc.WrappedAsyncTaskLoader;
import com.abdipor.music1.model.Song;
import com.abdipor.music1.util.DensityUtil;
import com.abdipor.music1.util.FileUtil;
import com.abdipor.music1.util.PreferenceUtil;
import com.abdipor.music1.util.NotrikaColorUtil;
import com.abdipor.music1.util.ThemedFastScroller;
import com.abdipor.music1.views.BreadCrumbLayout;
import com.abdipor.music1.views.ScrollingViewOnApplyWindowInsetsListener;
...
public class FoldersFragment extends AbsMainActivityFragment implements
    ...
    public MaterialCab openCab(int menuRes, MaterialCab.Callback callback) {
        ...
        cab = new MaterialCab(getMainActivity(), R.id.cab_stub)
                ...
                .setBackgroundColor(NotrikaColorUtil.shiftBackgroundColorForLightText(
