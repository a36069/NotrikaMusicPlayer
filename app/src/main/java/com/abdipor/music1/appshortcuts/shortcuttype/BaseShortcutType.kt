...
package com.abdipor.music1.appshortcuts.shortcuttype
...
import com.abdipor.music1.appshortcuts.AppShortcutLauncherActivity
...
abstract class BaseShortcutType(internal var context: Context) {
    ...
    companion object {
        internal const val ID_PREFIX = "com.abdipor.music1.NotrikaMusic.appshortcuts.id."
        val id: String
