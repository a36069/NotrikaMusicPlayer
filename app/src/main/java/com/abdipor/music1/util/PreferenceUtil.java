...
import com.abdipor.music1.fragments.mainactivity.FoldersFragment;
import com.abdipor.music1.helper.SortOrder;
import com.abdipor.music1.helper.SortOrder.AlbumSongSortOrder;
import com.abdipor.music1.model.CategoryInfo;
import com.abdipor.music1.model.CategoryInfo.Category;
import com.abdipor.music1.transform.CascadingPageTransformer;
import com.abdipor.music1.transform.DepthTransformation;
import com.abdipor.music1.transform.HingeTransformation;
import com.abdipor.music1.transform.HorizontalFlipTransformation;
import com.abdipor.music1.transform.NormalPageTransformer;
import com.abdipor.music1.transform.VerticalFlipTransformation;
import com.abdipor.music1.transform.VerticalStackTransformer;
...
public final class PreferenceUtil {
    ...
    public static int getThemeResFromPrefValue(@NonNull String themePrefValue) {
        switch (themePrefValue) {
            case "light":
                return R.style.Theme_NotrikaMusic_Light;
            case "dark":
            default:
                return R.style.Theme_NotrikaMusic;
        }
    }
    ...
    public List<CategoryInfo> getDefaultLibraryCategoryInfos() {
        ...
        defaultCategoryInfos.add(new CategoryInfo(Category.FOLDER, true));
        ...
        defaultCategoryInfos.add(new CategoryInfo(Category.ARTISTS, false));
